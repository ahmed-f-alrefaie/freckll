...
from freckll.reactions.photo import CrossSection, QuantumYield, PhotoMolecule
import numpy as np
...
def test_photomolecule_interpolation():
    ...
    np.testing.assert_allclose(interpolated_photo_molecule.cross_section.wavelength.value,[205., 215.])
