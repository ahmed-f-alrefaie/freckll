...
def test_invert_two():
   ...
   thermo_inv_react = np.array([[[ 1.39903735, 59.59142273],
        ...
        [ 5.07443463, 64.15061228]]]).transpose((0,2,1))
   thermo_inv_prod = np.array([[[ 8.47271071, 41.49035985],
       ...
       [[-3.86679318, 30.75716691],
        ...
        [-1.932018  , 31.9279543 ]]]).transpose((0,2,1))

   k0 = np.array([2.14302301e-12, 2.06574483e-12, 1.82022574e-12, 1.42193639e-12,
      7.41243112e-13, 4.89248087e-13, 6.40569833e-13, 1.02172631e-12,
      1.50441208e-12, 2.09595982e-12, 2.77130309e-12, 3.78600113e-12,
      5.30198818e-12])
   kinf = np.zeros_like(k0)
   temperature = np.array([1846.3, 1827.5, 1764.8, 1651.1, 1398.2, 1266.1, 1349.5, 1515. ,
         1676.1, 1834.9, 1986. , 2176.5, 2412. ])
   
   k0inv,_,keq = invert_reaction(thermo_inv_reactants=thermo_inv_react, thermo_inv_products=thermo_inv_prod, k0=k0, k_inf=kinf, temperature=temperature)

   expected_k0inv = np.array([1.08169270e+11, 1.01914639e+11, 8.27567529e+10, 5.43819482e+10,
       1.65153289e+10, 7.26398010e+09, 1.24409527e+10, 3.01567649e+10,
       5.99472680e+10, 1.04348058e+11, 1.62322915e+11, 2.58871814e+11,
       4.15392708e+11])
   
   expected_keq = np.array([1.98117544e-23, 2.02693633e-23, 2.19948907e-23, 2.61472131e-23,
       4.48821283e-23, 6.73526194e-23, 5.14888088e-23, 3.38805014e-23,
       2.50955903e-23, 2.00862370e-23, 1.70727780e-23, 1.46250033e-23,
       1.27637970e-23])
